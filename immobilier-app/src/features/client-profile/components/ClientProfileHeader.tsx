...
export const ClientProfileHeader: React.FC<ClientProfileHeaderProps> = ({ profile }) => {
  const { user } = useAuth();
          ...
          <div className="flex flex-col items-center text-center gap-4">
            <div className="relative">
              <Avatar className="h-24 w-24 border-4 border-white">
                ...
                />
                <AvatarFallback className="bg-gradient-to-br from-blue-400 to-indigo-500 text-white text-xl font-bold">
              ...
              <div className="flex items-center justify-center gap-3">
                {profile.nbRates === 0 ? (
                  <div className="flex items-center gap-2 text-gray-500 bg-white px-3 py-1.5 rounded-full">
                    ...
                    <span className="text-sm font-medium">Nouveau voyageur</span>
                  </div>
                ) : (
        ...
        {profile.nbRates > 0 && (
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
            <div className="text-center bg-gray-50 rounded-lg p-3">
              <div className="text-2xl font-bold text-blue-600 mb-1">{profile.nbRates}</div>
              <div className="text-gray-600 text-xs font-medium">Avis reçus</div>
            </div>
            <div className="text-center bg-gray-50 rounded-lg p-3">
              <div className="text-2xl font-bold text-blue-600 mb-1">{formatRate(profile.rate)}</div>
