...
const Footer: React.FC = () => {
  ...
  const services = [
    { label: "Location courte durée", href: "/categories?type=rent-short" },
    { label: "Location longue durée", href: "/categories?type=rent-long" },
    { label: "Vente de propriétés", href: "/categories?type=selle" },
